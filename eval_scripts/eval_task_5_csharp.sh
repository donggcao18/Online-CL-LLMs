#!/bin/bash
#SBATCH -J cl_eval_5_csharp
#SBATCH -o cl_eval_5_csharp-%j.out
#SBATCH -p compute
#SBATCH -N 1
#SBATCH -t 20:00:00
#SBATCH --mem 128G
...
PREV_LORA_PATH="${BASE_DIR}/1-python/saved_weights,${BASE_DIR}/2-cpp/saved_weights,${BASE_DIR}/3-swift/saved_weights,${BASE_DIR}/4-rust/saved_weights"
EVAL_TASKS=(python cpp swift rust csharp)
